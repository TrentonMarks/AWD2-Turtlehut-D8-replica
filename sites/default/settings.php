...
$settings['config_sync_directory'] = 'sites/default/files/config_acqTmp-2020-07-15T08.23.22-3181/sync';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_replica_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_replica_dd.inc';
}
// </DDSETTINGS>
